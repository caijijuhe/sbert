...
def evaluate(model):
    ...
    pred = list((sims > 0.8).astype(int))
    S = classification_report(list(all_labels), pred)
...
if __name__ == '__main__':
    ...
    tokenizer = BertTokenizer.from_pretrained('pretrain_model/bert-base-chinese/config.json')
