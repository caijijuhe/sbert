...
if __name__ == '__main__':
    train_data_path = 'data/tungee/a.txt'
    test_data_path = 'data/tungee/b.txt'
    ...
    with gzip.open('./data/tungee/a.pkl.gz', 'wb') as fout:
        pickle.dump(train_features, fout)
    with gzip.open('./data/tungee/b.pkl.gz', 'wb') as fout:
