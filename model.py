...
class SentenceBert(nn.Module):
    def __init__(self):
        ...
        self.config = BertConfig.from_pretrained('pretrain_model/bert-base-chinese/config.json')
        self.model = BertModel.from_pretrained('pretrain_model/bert-base-chinese/pytorch_model.bin', config=self.config)
